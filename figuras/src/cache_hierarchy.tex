...
\begin{tikzpicture}[
    ...
    % Shared L3 Cache
    \node[l3] (l3_a) at (2.5, 0.7) {\textbf{Shared Last-Level Cache}\\Automaton (1.93 MiB) fits inside};
    ...
    \node[note, anchor=north] at (2.5, -2.2) {Throughput: \textbf{high}\\Scales with core count.};
    ...
    \begin{scope}[xshift=9.0cm]
        ...
        % Shared L3 Cache
        \node[l3, draw=warm, fill=warm!5] (l3_b) at (2.5, 0.7) {\textbf{Shared Last-Level Cache}\\Automaton (506.78 MiB) exceeds capacity};
        
        % Cache Misses
        \draw[missarrow] (l2_0_b) -- (0, 1.1);
        \draw[missarrow] (l2_1_b) -- (2.5, 1.1);
        \draw[missarrow] (l2_2_b) -- (5.0, 1.1);
        \node[warm, font=\scriptsize\bfseries, fill=white, inner sep=2pt] at (2.5, 1.4) {Cache Misses};
        ...
        \node[note, anchor=north] at (2.5, -2.2) {Throughput: \textbf{low}\\Scaling limited by memory bandwidth.};
    \end{scope}
