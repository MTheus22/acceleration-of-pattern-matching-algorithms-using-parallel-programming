...
holding one \texttt{runs} table (one row per timed execution) together with a
set of aggregating views. The headline figures are obtained from those views
rather than from the raw execution logs.
