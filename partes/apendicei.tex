...
sweep script and timing log for that earlier campaign are not currently archived
in the repository, a reproducibility limitation noted explicitly in the Results
chapter when those figures are discussed.
