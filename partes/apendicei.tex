...
database from which every quantitative result reported in this thesis is
derived, so that the figures can be reproduced and audited independently. The
benchmark campaign stores its measurements in a single typed SQLite file,
