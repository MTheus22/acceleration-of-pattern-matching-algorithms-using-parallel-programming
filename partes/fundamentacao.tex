...
Speedup (\texttt{S}) measures the performance gain achieved through parallel execution relative to sequential execution and it is referenced as Equation \ref{eq:speedup}. It is defined as the ratio of sequential execution time to parallel execution time:
\begin{equation}
    S = \frac{T_s}{T_p}
    \label{eq:speedup}
\end{equation}
