...
A Trie---also known as a prefix tree---is a specialized tree-like data structure optimized for the efficient storage and retrieval of a dynamic set of strings. Edward Fredkin introduced the term "trie" in 1960, highlighting its primary application in information retrieval \cite{Fredkin1960, Knuth1998}. Figure \ref{fig:trie-example} illustrates an example of a trie storing a set of words.

% Figura da Trie
\begin{figure}[htbp] % h=here, t=top, b=bottom, p=page
  \centering % Centraliza a figura

  \includegraphics[width=0.5\textwidth, height=0.41\textheight, keepaspectratio]{trie.pdf}
