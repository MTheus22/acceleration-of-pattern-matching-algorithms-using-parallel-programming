...
The Aho-Corasick algorithm exhibits optimal \textit{linear time complexity} for multi-pattern matching \cite{AhoCorasick1975},{Gusfield1997}. For both the construction and search phases, the complexities are as follows:
